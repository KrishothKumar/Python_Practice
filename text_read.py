...
if __name__=="__main__":
    ...
    line, word, character = checking_line(file)
    print("Number of lines in given file is",line)
    print("Number of words in given file is",word)
    print("Number of character in given file is",character)
